...
import { View, Text, Pano, AppRegistry, asset, StyleSheet }  from 'react-360';
...
export default class WorldTourPat extends React.Component {
  constructor() {
    super();
...
AppRegistry.registerComponent('WorldTourPat', () => WorldTourPat);
